 ...
 * OTP verification, rate limits, and multi-sensor workspace sessions.
 */
...
const LOCAL_USERS_KEY = 'geoclass_users_v1';
const LOCAL_RATE_KEY = 'geoclass_ratelimit_v1';
...
export const authService = {
  ...
  /**
   * Clear rate limit locally and in Supabase
   */
